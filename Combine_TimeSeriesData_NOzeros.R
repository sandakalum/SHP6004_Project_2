...
#Read data
DiasBP = read.csv("DiasBP_Filtered_NOzero.csv")[,-1]
HeartRate= read.csv("HeartRate_Filtered_NOzero.csv")[,-1]
MeanBP = read.csv("MeanBP_Filtered_NOzero.csv")[,-1]
SpO2 = read.csv("SpO2_Filtered_NOzero.csv")[,-1]
SysBP = read.csv("SysBP_Filtered_NOzero.csv")[,-1]
TempC = read.csv("TempC_Filtered_NOzero.csv")[,-1]
...
write.csv(x_AllData, file = "x_AllData_NOzero.csv")
write.csv(y_AllData, file = "y_AllData_NOzero.csv")
# 
